...
cols[0].markdown(
    ...
    <div class="card">
        <div class = "card-title">
            <div class="card-content">pose</div>
        </div>
        <iframe src="http://localhost:5000/audio_feed" width="100%" height="100%" frameborder="0" scrolling="no">
        </iframe>
    </div>""",
    unsafe_allow_html=True,
)
